...
xueqiu rate-limits like any public site. xue already paces
...
Where a surface is gated, xue reads a cookie or token you supply
...
`xue`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what xue actually did
