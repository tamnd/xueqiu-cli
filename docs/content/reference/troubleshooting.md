...
Most of these come down to network reality or how xueqiu serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

xueqiu rate-limits like any public site. xueqiu already paces
...
Where a surface is gated, xueqiu reads a cookie or token you supply
...
`xueqiu`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what xueqiu actually did
