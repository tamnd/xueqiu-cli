...
func TestHostWiring(t *testing.T) {
	...
	if want := "xueqiu://page/wiki/Go"; u.String() != want {
	...
	got, err := h.ResolveOn("xueqiu", "about")
	if err != nil || got.String() != "xueqiu://page/about" {
		t.Errorf("ResolveOn = (%q, %v), want xueqiu://page/about", got.String(), err)
	}
}
